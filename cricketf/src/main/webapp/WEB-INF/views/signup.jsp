...
<body>
	<form:form id="regForm" modelAttribute="createuser" action="signupProcess"
		method="post">
				...
				<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<form:input path="firstName" name="firstName" id="firstName"
							required="true" pattern="[a-zA-Z]{4,12}" class="form-control"
					...
					<div class="form-group">
						...
						<form:input path="password" type="password" id="password"
							required="true" pattern="[a-zA-Z0-9]{8,12}" class="form-control"
					...
					<div class="form-group">
						...
						<form:input path="confirmPassword" type="password"
							id="confirmPassword" required="true" pattern="[a-zA-Z0-9]{8,12}"
